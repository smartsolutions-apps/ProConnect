...
export const AdminDashboard: React.FC = () => {
    const { companies: hydratedCompanies, jobs: hydratedJobs } = useHydratedData();
    ...
    useEffect(() => {
        setAllCompanies(hydratedCompanies);
    }, [hydratedCompanies]);
                ...
                <div className="flex gap-4 border-b border-gray-100 dark:border-[#333333] overflow-x-auto no-scrollbar">
                    {[
                        ...
                        <button
                            ...
                            className={`pb-3 text-sm font-bold whitespace-nowrap transition-colors border-b-2 px-1 ${activeTab === tab.id ? 'border-red-600 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-800 dark:hover:text-white'
                                }`}
                        >
                            {tab.label}
                        </button>
